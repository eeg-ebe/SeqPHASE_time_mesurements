...
haxe -main SeqPhase1 -dce full -js seqphase1_dce_full.js -lib hxnodejs
haxe -main SeqPhase1 -dce std -js seqphase1_dce_std.js -lib hxnodejs
haxe -main SeqPhase1 -dce no -js seqphase1_dce_no.js -lib hxnodejs
...
haxe -main SeqPhase2 -dce full -js seqphase2_dce_full.js -lib hxnodejs
haxe -main SeqPhase2 -dce std -js seqphase2_dce_std.js -lib hxnodejs
haxe -main SeqPhase2 -dce no -js seqphase2_dce_no.js -lib hxnodejs
